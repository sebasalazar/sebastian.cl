...
public class ServicioEmailImpl implements ServicioEmail, Serializable {
    ...
    public boolean sendMail(final String to, final String from, final String subject, final String message) {
        ...
        try {
            ...
            logger.debug("Error al enviar correo electronico", e);
        }
    ...
    @Override
    public boolean sendMail(final InternetAddress to, final InternetAddress from, final String subject, final String message, final byte[] file, final String fileName, final String mimeType) {
        boolean result = true;
        try {
            MimeMessagePreparator preparator = new MimeMessagePreparator() {
                @Override
